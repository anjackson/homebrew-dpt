...
class Disktype < Formula
  ...
  #url 'http://prdownloads.sourceforge.net/disktype/disktype-9.tar.gz'
  #md5 '25a673f162b9c01cd565109202559489'
  url 'http://disktype.cvs.sourceforge.net/viewvc/disktype/disktype/?view=tar'
  md5 'd05c96d50c0e55fe721aec978bf88643'
  version '10-SNAPSHOT'
